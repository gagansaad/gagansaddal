...
exports.successJSONResponseWithPagination = async (
  res,
  responseModel,
  OnPage,
  perPage = 10,
  ...
  if (res) {
    ...
    if (dbquery) {
      responseModelWithLimit = await responseModel
        .find(dbquery)
        .populate({
          path: "adsInfo.image",
