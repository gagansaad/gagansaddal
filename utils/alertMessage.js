module.exports = {
  ...
  facebookAccountExist:
    "You already have an account with Facebook, please login via Facebook.",
  googleAccountExist:
    "You already have an account with Google, please login via Google.",
  emailAccountExist:
    "You already have an account with this mail address, please login via Email.",
  appleAccountExist:
    "You already have an account with Apple, please login via Apple.",
